...
//                     <img className='w-16 bg-gray-400 rounded-full cursor-pointer' src={ docImg ? URL.createObjectURL(docImg) : assets.upload_area} alt="" />
//                 </label>
...
//                 <div className='w-full lg:flex-1 flex flex-col gap4'>
    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-slate-100 px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          <label htmlFor='doc-img'>
            <img
              className='w-16 h-16 object-cover bg-gray-400 rounded-full cursor-pointer'
